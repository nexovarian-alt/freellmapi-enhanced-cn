...
// ERNIE 4.5 Turbo 128K, ERNIE Speed, ERNIE Lite, ERNIE 4.0, etc.
// API Key from console.bce.baidu.com/qianfan (free tier: ~500K tokens/day).
// Qianfan cold-start models can exceed the default 15s timeout; 60s covers
// most cases including ERNIE 4.5 Turbo reasoning.
register(new OpenAICompatProvider({
...
// Aliyun Bailian (阿里云百炼 / DashScope) — OpenAI-compatible.
// Qwen-Plus, Qwen-Turbo, Qwen-Long, Qwen-Max, Qwen-Flash, DeepSeek-V3, DeepSeek-R1, etc.
// API Key from bailian.console.aliyun.com.
// The compatible-mode endpoint accepts standard OpenAI-format requests
// and returns OpenAI-format responses without translation.
register(new OpenAICompatProvider({
